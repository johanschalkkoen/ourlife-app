...
const db = new sqlite3.Database('/root/ourlife.run.place/dev-ourlife.db', (err) => {
    if (err) {
...
const httpsOptions = {
    key: fs.readFileSync('/etc/letsencrypt/live/ourlife.run.place/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/ourlife.run.place/fullchain.pem')
};
